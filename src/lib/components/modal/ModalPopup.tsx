...
interface ICategoryClose{
  closeModal:()=>void
}
const ModalPopup:React.FC<ICategoryClose>=({closeModal})=>{
  ...
  async function handleSubmitCategoryData(e:FormEvent<HTMLFormElement >){
    e.preventDefault()
  ...
  <div className="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
    ...
    <div className="space-y-4">
      <div>
        ...
        <input onChange={handleChangeCategoryData} type="text" name="categoryName" id="website_url" className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500" placeholder="Category Name" required />
      </div>
      <div>
      ...
      <form onSubmit={handleSubmitCategoryData} className="flex justify-end gap-3">
